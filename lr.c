...
float t;
    v1=v1*1000/3600;//перевод скорости в м/с
    t=l/v1;//вычисление времени
    return t;
}
int pow(int x, int y){
    int x1=x;
...
int lab1(){
float v1, l, t;
    scanf("%f", &l);//ввод рассто€ни€ в метрах
    scanf("%f", &v1);//ввод скорости в км/ч
    v1=v1*1000/3600;//перевод скорости в м/с
    t=l/v1;//вычисление времени
    printf("%f", t);
return 0;
...
int lab11(){
    ...
    scanf("%f", &l);//ввод рассто€ни€ в метрах
    scanf("%f", &v1);//ввод скорости в км/ч
    printf("%.2f", put(v1, l));//вывод времени
    return 0;
}
